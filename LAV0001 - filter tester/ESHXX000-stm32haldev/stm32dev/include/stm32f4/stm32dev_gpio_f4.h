 ...
 *
 */
bool stm32dev_gpio_getPinState(GPIO_TypeDef* pinBank, uint8_t pinPlace);
void stm32dev_gpio_setPinState(GPIO_TypeDef* pinBank, uint8_t pinPlace, bool newState);
